...
# 最高优先级
优先关注能体现 AI 行业实质进展的三条主线：
- 产品与技术落地：操作系统级 AI、超级 App + AI、产品发布、能力升级、开发者生态、端侧 AI、智能硬件、第三方接入、插件或生态开放。
- 产业政策风向标：AI/智能硬件相关扶持、监管、标准、准入、政府采购、产业规划、资金支持、关键城市或部委政策。
- 商业化落地信号：付费/API/订阅/价格策略、企业客户采用、生态合作、渠道接入、用户或营收增长、可复制的商业模式变化。

# 筛选原则
1. 只阐述事实价值，不追求标题党或情绪化表达。
2. 优先选择产品发布、能力升级、开发者生态、模型能力落地、端侧 AI、智能硬件、产业政策风向标、商业化落地信号相关内容。
3. 商业化动态可入选，但必须能说明 AI 产品正在被真实用户、企业客户、开发者或生态伙伴采用；普通品牌宣传、泛商业动态、泛财报、单纯资本市场叙事应降低优先级。
...
7. 融资、IPO、估值、股价、普通投资事件不得因涉及 AI 公司而入选；只有当融资不是核心事实，且标题摘要中存在明确技术、产品、论文或模型能力进展时，才允许选择。
